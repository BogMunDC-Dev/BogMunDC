const db = {
    ...
    modelos2025: {
        1: {
            ...
            linkInstagram: "https://www.instagram.com/vmun2025/",
            locacion: "Cl. 195 #54 -75, Bogotá"
        },
        2: {
            nombre: "RMUN XX",
            institucion: "Colegio Rochester",
            Fecha: "27, 28 y 29 de Enero",
            linkInstagram: "https://www.instagram.com/rochester.mun/",
            locacion: "Vereda Fusca, Chía, Cundinamarca, 250008"
        },
        3: {
            nombre: "TVSMUN XVIII",
            institucion: "Colegio The Victoria School",
            Fecha: "7, 8 y 9 de Febrero",
            linkInstagram: "https://www.instagram.com/tvsmun/",
            locacion: "Calle 215 No. 50-60, Suba, Bogotá"
        },
        4: {
            nombre: "CSVMUN IV",
            institucion: "Colegio San Viator",
            ...
            linkInstagram: "https://www.instagram.com/csvmun_/",
            locacion: "Autopista Nte. #209-51, Suba, Bogotá"
        },
        5: {
            nombre: "MMUN XV",
            institucion: "Colegio Marymount",
            Fecha: "24, 25 y 26 de Febrero",
            linkInstagram: "https://www.instagram.com/mmun2025/",
            locacion: "Cl. 169 #74A-02, Bogotá"
        },
        6: {
            nombre: "SACMUN XIX",
            institucion: "Colegio San Carlos",
            Fecha: "28 (feb), 1 y 2 de Marzo",
            linkInstagram: "https://www.instagram.com/sacmuncsc/",
            locacion: "Cl. 192 #9 -45, Bogotá"
        },
        7: {
            nombre: "GICMUN IX",
            institucion: "Colegio Gimnasio Campestre",
            Fecha: "7, 8 y 9 de Marzo",
            linkInstagram: "https://www.instagram.com/gicmun/",
            locacion: "Cl. 165 #8a-50, Bogotá"
        },
        8: {
            nombre: "TESMUN XXI",
            institucion: "Colegio The English School",
            Fecha: "13, 14, 15 y 16 de Marzo",
            linkInstagram: "https://www.instagram.com/officialtesmun/",
            locacion: "Cl. 170 #15-68, Bogotá"
        },
        9: {
            nombre: "CNGMUN XLIII",
            institucion: "Colegio Nueva Granada",
            Fecha: "20, 21 y 22 de Marzo",
            linkInstagram: "https://www.instagram.com/cngmun2025/",
            locacion: "Cra 2 Este #70-20, Bogotá"
        },
        10: {
            nombre: "CLCMUN XIV",
            institucion: "Colegio La Colina",
            Fecha: "28, 29 y 30 de Marzo",
            linkInstagram: "https://www.instagram.com/clcmunoficial/",
            locacion: "KM 9.5, Vía a Mundo Nuevo, Vda. El Salitre, La Calera"
        },
        11: {
            nombre: "SMMUN XV",
            institucion: "Colegio San Mateo",
            Fecha: "28, 29 y 30 de Marzo",
            linkInstagram: "https://www.instagram.com/smmunxv/",
            locacion: "Cra. 75 #212-37, Bogotá"
        },
        12: {
            nombre: "MUNARB V",
            institucion: "Gimnasio la Arboleda",
        ...
        13: {
            ...
            institucion: "Colegio Buckingham",
            Fecha: "4, 5 y 6 de Abril",
            linkInstagram: "https://www.instagram.com/buckmun_xvii/",
            locacion: "Cra. 45 #123-60, Bogotá"
        },
        14: {
            nombre: "CSMUN XI",
            institucion: "Colegio Bilingüe Clermont",
            Fecha: "9, 10 y 11 de Abril",
            linkInstagram: "https://www.instagram.com/csmun_xi/",
            locacion: "Tv. 80 #213a-17, Bogotá"
        },
        15: {
            nombre: "GMUN X",
            institucion: "Colegio Colombo Gales",
        ...
        16: {
            nombre: "MUNUS '25",
            institucion: "Universidad de la Sabana",
            Fecha: "24, 25, 26 y 27 de Abril",
            linkInstagram: "https://www.instagram.com/munus_usabana/",
            locacion: "Chía"
        },
        17: {
            nombre: "PACHASMUN I",
            institucion: "Colegio Santa Francisca Romana",
            Fecha: "25, 26 y 27 de Abril",
            linkInstagram: "https://www.instagram.com/pachasmun/",
            locacion: "Cl. 151 #1640, Bogotá"
        },
        18: {
            nombre: "GMMUN XVIII",
            institucion: "Colegio Gimnasio Moderno",
            Fecha: "2, 3 y 4 de Mayo",
            linkInstagram: "https://www.instagram.com/gmmunxviii/",
            locacion: "Cra. 9 #74-99, Bogotá"
        },
        19: {
            nombre: "NESMUN",
            ...
            linkInstagram: "https://www.instagram.com/nesmun_/",
            locacion: "Cl. 215 #50 -60, Suba, Bogotá"
        },
        20: {
            nombre: "MUNECA XXV",
        ...
        21: {
            ...
            linkInstagram: "https://www.instagram.com/cumun_/",
            locacion: "Auton. Km. 6 Vereda Yerbabuena, Chía"
        },
        22: {
            nombre: "SBLMUN XVII",
            institucion: "Colegio San Bartolomé",
            Fecha: "21, 22 y 23 de Mayo",
            linkInstagram: "https://www.instagram.com/sblmunoficial/",
            locacion: "Cra. 7 #9 - 60, La Candelaria, Bogotá"
        },
        23: {
            nombre: "SPMUN II",
        ...
        24: {
            ...
            linkInstagram: "https://www.instagram.com/cnymun_/",
            locacion: "entre Autopista Norte y Cra. 7 #Cl. 200, Bogotá"
        },
        25: {
            nombre: "FEMMUN VI",
            institucion: "Colegio Gimnasio Femenino",
        ...
        27: {
            nombre: "MBSMUN XIII",
            institucion: "Colegio Montessori British School",
            Fecha: "16, 17 y 18 de Junio",
            linkInstagram: "https://www.instagram.com/mbsmun/",
            locacion: "Cl. 128 #72 - 80, Suba, Bogotá"
        },
        28: {
            nombre: "LCBMUN VIII",
            institucion: "Liceo de la Colombia Bilingüe",
            Fecha: "16, 17 y 18 de Junio",
            linkInstagram: "https://www.instagram.com/lcb.mun/",
            locacion: "Suba"
        },
        29: {
            nombre: "EMUN XIII",
            ...
            linkInstagram: "https://www.instagram.com/ensenanzamodelun/",
            locacion: "Av. El Polo, Cl. 106#7-12, Suba, Bogotá"
        },
        30: {
            nombre: "MONUA 2025",
            institucion: "Universidad de los Andes",
            Fecha: "15, 16, 17 y 19 de Agosto",
            linkInstagram: "https://www.instagram.com/monuauandes/",
            locacion: "Cra. 1 #18a-12, Bogotá"
        },
        31: {
            nombre: "GLPMUN X",
        ...
        32: {
            nombre: "EDMUN V",
            institucion: "Colegio Emmanuel D'Alzon",
            Fecha: "24, 25 y 26 de Septiembre",
            linkInstagram: "https://www.instagram.com/edmun.25/",
            locacion: "Tv. 56 #114-50, Bogotá"
        },
        33: {
            nombre: "JDSMUN III",
            ...
            linkInstagram: "https://www.instagram.com/jdsmun/",
            locacion: "Cra. 1 #68-50, Bogotá"
        },
        34: {
            nombre: "PUJMUN XI",
            institucion: "Pontificia Universidad Javeriana",
            Fecha: "17, 18, 19 y 20 de Octubre",
            linkInstagram: "https://www.instagram.com/pujmun/",
            locacion: "Cra. 7 #40 - 62, Bogotá"
        }        
    },
